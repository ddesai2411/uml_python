...
# We need to pass in the headers so this works for more than just PO or Invoice
...
def makeHTMLbottom(tstamp):
    retVal = '<script src="table3.js"></script>\n'
    retVal += "<p class='i'>Last updated: " + tstamp + "</p><body>\n</html>\n"
    return retVal
